...
namespace CLEO
{
    ...
    private:
        ...
        static OpcodeHandler originalOpcodeHandlers[Original_Opcode_Handlers_Count]; // backuped when patching

        static constexpr size_t Custom_Opcode_Handlers_Count = (Last_Custom_Opcode / Opcodes_Table_Size) + 1;
        static OpcodeHandler customOpcodeHandlers[Custom_Opcode_Handlers_Count]; // original + new opcodes
