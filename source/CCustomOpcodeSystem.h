...
class CCustomOpcodeSystem
{
  public:
    ...
    static OpcodeResult CleoReturnGeneric(WORD opcode, CRunningScript* thread, bool returnArgs = false,
                                          DWORD returnArgCount = 0, bool strictArgCount = true);
  ...
  private:
    ...
    static OpcodeResult __fastcall customOpcodeHandler(CRunningScript* thread, int dummy,
