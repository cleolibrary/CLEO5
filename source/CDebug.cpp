...
void CDebug::Trace(CLEO::eLogLevel level, const char* msg)
{
    ...
    if (usersDirPos != nullptr)
    {
        ...
        size_t userEnd = msgStr.find_first_of("\\/*\"<>:|?",
                                              userBegin); // till next path separator or any invalid filepath character
    ...
    if (m_hFile.good())
    {
        ...
        sprintf_s(timestampStr, "%02d/%02d/%04d %02d:%02d:%02d.%03d ", t.wDay, t.wMonth, t.wYear, t.wHour, t.wMinute,
