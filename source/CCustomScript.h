...
class CCustomScript : public CRunningScript
{
  ...
  public:
    ...
    inline DWORD GetCodeSize() const
    {
        return m_codeSize;
    }
    inline void SetCodeSize(DWORD size)
    {
        m_codeSize = size;
    }
    inline DWORD GetCodeChecksum() const
    {
        return m_codeChecksum;
    }
    inline void EnableSaving(bool en = true)
    {
        m_saveEnabled = en;
    }
    inline void SetCompatibility(eCLEO_Version ver)
    {
        m_compatVer = ver;
    }
    inline eCLEO_Version GetCompatibility() const
    {
        return m_compatVer;
    }
