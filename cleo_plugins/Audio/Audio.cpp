...
public:
    ...
    Audio()
    {
        ...
        CLEO_RegisterCallback(eCallbackId::GameAfterProcess, OnGameAfterProcess);
    ...
    ~Audio()
    {
        ...
        CLEO_UnregisterCallback(eCallbackId::GameAfterProcess, OnGameAfterProcess);
    ...
    static void __stdcall OnGameAfterProcess()
    {
        soundSystem.Process();
    }
