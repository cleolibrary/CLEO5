...
BOOL BASSDEF(BASS_Init)(int device, DWORD freq, DWORD flags, void* win, const void* dsguid);
    ...
    HSAMPLE BASSDEF(BASS_SampleLoad)(
        DWORD filetype, const void* file, QWORD offset, DWORD length, DWORD max, DWORD flags
    );
    ...
    HMUSIC BASSDEF(BASS_MusicLoad)(
        DWORD filetype, const void* file, QWORD offset, DWORD length, DWORD flags, DWORD freq
    );
...
static inline HMUSIC BASS_MusicLoad(
    DWORD filetype, const WCHAR* file, QWORD offset, DWORD length, DWORD flags, DWORD freq
)
{
    return BASS_MusicLoad(filetype, (const void*)file, offset, length, flags | BASS_UNICODE, freq);
}

static inline HSAMPLE BASS_SampleLoad(
    DWORD filetype, const WCHAR* file, QWORD offset, DWORD length, DWORD max, DWORD flags
)
{
