...
class FileSystemOperations
{
  public:
    ...
    ~FileSystemOperations() { CLEO_UnregisterCallback(eCallbackId::ScriptsFinalize, OnFinalizeScriptObjects); }
            ...
            do
            {
                ...
                if (wfd.dwFileAttributes & FILE_ATTRIBUTE_DIRECTORY)
                {
                    if ((strcmp(wfd.cFileName, "..") != 0) && (strcmp(wfd.cFileName, ".") != 0))
                    {
                        ...
                        if (!DeleteDir(subPath)) return FALSE;
                    }
                }
                else
                {
                    ...
                    // delete file
                    if (!DeleteFile(subPath)) return FALSE;
                }
