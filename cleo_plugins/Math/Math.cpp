...
public:
    ...
    //0A8E=3,%3d% = %1d% + %2d% ; int
    static OpcodeResult __stdcall opcode_0A8E(Script* script)
    {
    ...
    //0A8F=3,%3d% = %1d% - %2d% ; int
    static OpcodeResult __stdcall opcode_0A8F(Script* script)
    {
        auto a = OPCODE_READ_PARAM_INT();
        auto b = OPCODE_READ_PARAM_INT();
    ...
    //0A90=3,%3d% = %1d% * %2d% ; int
    static OpcodeResult __stdcall opcode_0A90(Script* script)
    {
        auto a = OPCODE_READ_PARAM_INT();
        auto b = OPCODE_READ_PARAM_INT();
    ...
    //0A91=3,%3d% = %1d% / %2d% ; int
    static OpcodeResult __stdcall opcode_0A91(Script* script)
    {
        auto a = OPCODE_READ_PARAM_INT();
        auto b = OPCODE_READ_PARAM_INT();
    ...
    static OpcodeResult __stdcall opcode_0AEE(Script* script)
    {
    ...
    static OpcodeResult __stdcall opcode_0AEF(Script* script)
    {
    ...
    static OpcodeResult __stdcall Script_IntOp_AND(Script* script)
        /****************************************************************
        Opcode Format
        0B10=3,%3d% = %1d% AND %2d%
        ****************************************************************/
    ...
    static OpcodeResult __stdcall Script_IntOp_OR(Script* script)
        /****************************************************************
        Opcode Format
        0B11=3,%3d% = %1d% OR %2d%
        ****************************************************************/
    ...
    static OpcodeResult __stdcall Script_IntOp_XOR(Script* script)
        /****************************************************************
        Opcode Format
        0B12=3,%3d% = %1d% XOR %2d%
        ****************************************************************/
    ...
    static OpcodeResult __stdcall Script_IntOp_NOT(Script* script)
        /****************************************************************
        Opcode Format
        0B13=2,%2d% = NOT %1d%
        ****************************************************************/
    ...
    static OpcodeResult __stdcall Script_IntOp_MOD(Script* script)
        /****************************************************************
        Opcode Format
        0B14=3,%3d% = %1d% MOD %2d%
        ****************************************************************/
    ...
    static  OpcodeResult __stdcall Script_IntOp_SHR(Script* script)
        /****************************************************************
        Opcode Format
        0B15=3,%3d% = %1d% SHR %2d%
        ****************************************************************/
    ...
    static OpcodeResult __stdcall Script_IntOp_SHL(Script* script)
        /****************************************************************
        Opcode Format
        0B16=3,%3d% = %1d% SHL %2d%
        ****************************************************************/
    ...
    *****************************************************************/
    ...
    static OpcodeResult __stdcall Scr_IntOp_AND(Script* script)
        /****************************************************************
        Opcode Format
        0B17=2,%1d% &= %2d%
        ****************************************************************/
    ...
    static OpcodeResult __stdcall Scr_IntOp_OR(Script* script)
        /****************************************************************
        Opcode Format
        0B18=2,%1d% |= %2d%
        ****************************************************************/
    ...
    static OpcodeResult __stdcall Scr_IntOp_XOR(Script* script)
        /****************************************************************
        Opcode Format
        0B19=2,%1d% ^= %2d%
        ****************************************************************/
    ...
    static OpcodeResult __stdcall Scr_IntOp_NOT(Script* script)
        /****************************************************************
        Opcode Format
        0B1A=1,~%1d%
        ****************************************************************/
    ...
    static OpcodeResult __stdcall Scr_IntOp_MOD(Script* script)
        /****************************************************************
        Opcode Format
        0B1B=2,%1d% %= %2d%
        ****************************************************************/
    ...
    static OpcodeResult __stdcall Scr_IntOp_SHR(Script* script)
        /****************************************************************
        Opcode Format
        0B1C=2,%1d% >>= %2d%
        ****************************************************************/
    ...
    static OpcodeResult __stdcall Scr_IntOp_SHL(Script* script)
        /****************************************************************
        Opcode Format
        0B1D=2,%1d% <<= %2d%
        ****************************************************************/
    ...
    static OpcodeResult __stdcall Sign_Extend(Script* script)
        /****************************************************************
        Opcode Format
    ...
    static OpcodeResult __stdcall opcode_2700(Script* script)
    {
        ...
        {
            SHOW_ERROR("Invalid '%d' bit index argument in script %s\nScript suspended.", bitIndex, ScriptInfoStr(script).c_str());
            return script->Suspend();
        }
    ...
    static OpcodeResult __stdcall opcode_2701(Script* script)
    {
    ...
    static OpcodeResult __stdcall opcode_2702(Script* script)
    {
        auto value = OPCODE_READ_PARAM_OUTPUT_VAR_INT();
        auto bitIndex = OPCODE_READ_PARAM_INT();
    ...
    static OpcodeResult __stdcall opcode_2703(Script* script)
    {
        auto value = OPCODE_READ_PARAM_OUTPUT_VAR_INT();
        auto bitIndex = OPCODE_READ_PARAM_INT();
    ...
    static OpcodeResult __stdcall opcode_2704(Script* script)
    {
    ...
    static OpcodeResult __stdcall opcode_2705(Script* script)
    {
        auto valueCount = CLEO_GetVarArgCount(script);

        if (valueCount < 2) // value + result
        {
            SHOW_ERROR("Insufficient number of arguments in script %s\nScript suspended.", ScriptInfoStr(script).c_str());
            return script->Suspend();
        }
    ...
    static OpcodeResult __stdcall opcode_2706(Script* script)
    {
        auto valueCount = CLEO_GetVarArgCount(script);
    ...
    static OpcodeResult __stdcall opcode_2707(Script* script)
    {
        auto valueCount = CLEO_GetVarArgCount(script);
    ...
    static OpcodeResult __stdcall opcode_2708(Script* script)
    {
