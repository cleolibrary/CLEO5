...
namespace CLEO
{
    ...
    */
    ...
    static void ShowError(const char* format, ...)
    {
        ...
        auto mainWnd = GetActiveWindow(); // *((HWND*)0x00C8CF88); // PluginSDK: RsGlobal.ps->window
        ...
        ShowCursor(true);
        MessageBoxA(mainWnd, msg, caption.c_str(), MB_SYSTEMMODAL | MB_TOPMOST | MB_ICONERROR | MB_OK);
        ShowCursor(false);
