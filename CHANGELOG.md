...
- fixed error in **0AB9 ([stream_custom_script](https://sannybuilder.com/#/sa/script/extensions/CLEO/0A92))** when game is installed in symlink or RAM Disk directory
